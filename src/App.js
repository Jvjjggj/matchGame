...
import ListOfImages from './Component/ListOfImgages/index'
...
class App extends Component {
  ...
  imageClcick = thumbnailUrl => {
    const {imgUrl} = this.state
    const imageValue = imagesList.filter(i => i.thumbnailUrl === thumbnailUrl)
  ...
  render() {
    ...
    const thumnailList = imagesList.filter(i => i.category === category)
              ...
              <ul>
                {thumnailList.map(i => (
                  <li key={i.id}>
                    <button
                      type="button"
                      onClick={() => this.imageClcick(i.thumbnailUrl)}
                    >
                      <img src={i.thumbnailUrl} alt="thumbnail" />
                    </button>
                  </li>
                ))}
              </ul>
